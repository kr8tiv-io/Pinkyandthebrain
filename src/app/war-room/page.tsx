          ...
          <div className="border-b border-[#333]/10 overflow-hidden py-1.5 relative">
            ...
            <div className="ticker-track">
              {['WAR ROOM v2.0', '$BRAIN INTELLIGENCE COMMAND', 'ALL DATA LIVE ON-CHAIN', 'NARF!', 'DEFLATIONARY SPL TOKEN', 'COMMUNITY GOVERNED',
                ...
                <span key={i} className="font-mono text-[6px] md:text-[7px] uppercase tracking-[0.3em] text-[#222] mx-4 md:mx-6 whitespace-nowrap group/ticker-item">
                  <span className="text-[#d4f000]/15 mr-2 inline-block transition-transform duration-300 group-hover/ticker-item:rotate-45">◆</span>
                  {item}
                </span>
              ))}
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center gap-2.5 md:gap-4 flex-wrap justify-center md:justify-end group/footer-links">
                ...
                <span className="font-mono text-[7px] uppercase tracking-[0.1em] text-[#1a1a1a] hover:text-[#333] transition-colors duration-300 flex items-center gap-1.5">
                  ...
                  <span className="text-[6px] text-[#1a1a1a]/60">v2.0.100</span>
                </span>
              </div>
            </div>
          </div>
