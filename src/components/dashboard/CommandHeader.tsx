...
function DataCell({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-[#d4f000]/70 to-[#d4f000]/15 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
