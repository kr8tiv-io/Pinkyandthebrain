...
const TICKER_ITEMS = [
  ...
  { text: 'DEFLATIONARY SPL TOKEN', color: 'text-[#bbb]' },
  { text: 'NARF!', color: 'text-[#ffadad]/70' },
  { text: 'SOL REFLECTIONS TO TOP 100', color: 'text-[#bbb]' },
  { text: '$BRAIN', color: 'text-[#d4f000]/80' },
  { text: '10% BURNED · 20% HOLDERS · 30% INVESTMENTS', color: 'text-[#bbb]' },
  { text: 'POIT!', color: 'text-[#ffadad]/70' },
  { text: '100% LP LOCKED', color: 'text-[#bbb]' },
  { text: 'ON-CHAIN TRANSPARENCY', color: 'text-[#bbb]' },
  { text: 'COMMUNITY GOVERNED', color: 'text-[#bbb]' },
  { text: 'THE SAME THING WE DO EVERY NIGHT', color: 'text-[#ddd]' },
  { text: '$BRAIN', color: 'text-[#d4f000]/80' },
...
export default function TokenInfoStrip() {
  return (
    <div className="w-full bg-[#0a0a0a] border-b border-[#555]/40 relative">
      {/* Top gradient accent */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#d4f000]/[0.30] to-transparent" />
      {/* Quick links row */}
      <div className="flex items-center gap-1 px-5 lg:px-8 py-2.5 overflow-x-auto">
        <div className="flex items-center gap-2 mr-3">
          <div className="w-0.5 h-3 bg-[#d4f000]/60" />
          <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#ddd] font-bold whitespace-nowrap">
            QUICK INTEL
          </span>
        </div>
          ...
          <a
            ...
            className={`font-mono text-[11px] transition-all px-2.5 py-1 whitespace-nowrap rounded-sm wr-link-scale wr-link-hover ${
              accent
                ...
                : 'text-[#ddd] hover:text-[#d4f000] hover:bg-[#d4f000]/[0.05]'
            }`}
          >
        ...
        <div className="flex items-center gap-1.5 px-2 py-1 whitespace-nowrap">
          ...
          <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-[#bbb] font-bold">SOLANA MAINNET</span>
        </div>
      </div>

      {/* Ticker tape with gradient fade edges */}
      <div className="border-t border-[#555]/30 overflow-hidden py-1.5 relative">
